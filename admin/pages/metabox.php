 		...
 		<div class="row">
			 <script>
				jQuery(document).ready(function() {
					jQuery('input[type=radio][name=post_for_radio]').click(function() {
						if (this.value == 'role') { 
				...
				<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">					
					 <label>
						  <?php 
							...
							?>
						<input type="radio" name="post_for_radio" id="post_for_radio" value="role" <?php echo $post_for1;?>> <?php _e('Only for the user role','epfitness');?> 
					</label>
				</div>
				<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">					
					 <label>
						 ...
						 ?>
						<input type="radio" name="post_for_radio" id="post_for_radio" value="user" <?php echo $post_for2;?>> <?php _e('Only specific users','epfitness');?> 
					</label>
				</div>
				<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">					
					 <label>
						 ...
						 ?>
						<input type="radio" name="post_for_radio" id="post_for_radio" value="Woocommerce" <?php echo $post_for3;?>> <?php _e('Woocommerce Products','epfitness');?> 
					</label>
				</div>	
