						...
						<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
								...
								<div class="col-md-6 ">
									<label>
									   <input type="text" class="form-control" id="package_order" value="<?php echo get_post_meta($package_id, 'ep_fitness_display_order', true); ?>" name="package_order" placeholder="Enter number e.g. 1">
									</label>
								</div>								
							  </div>
