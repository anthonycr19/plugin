		...
		public function ep_fitness_payment_post_type() {
			...
			public function custom_iv_payment_column( $column, $post_id ) {
				...
				public function admin_menu() {
					...
					self::$pages['wp-iv_record_fields'] = add_submenu_page('wp-ep_fitness', 'WP ep_fitness directory-admin', 'Record Fields', 'manage_options', 'wp-iv_record_fields', array(&$this, 'menu_hook'));
				...
				public function menu_hook() {
					...
					switch ($screen->id) {
						...
						break;
						case self::$pages['wp-iv_record_fields']:							
							require_once ('pages/record_fields.php');
				...
				public function ep_fitness_save_package() {
					...
					$post_content= $form_data['package_feature']; 
						...
						update_post_meta($newpost_id, 'ep_fitness_display_order', $form_data['package_order']);
						//Woocommerce_products
						if(isset($form_data['Woocommerce_product'])){
							update_post_meta($newpost_id, 'ep_fitness_package_woocommerce_product', $form_data['Woocommerce_product']);
				...
				public function iv_update_dir_setting(){
						...
						update_option('_dir_done',$form_data['dir_done']);
