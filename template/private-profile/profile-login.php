  ...
  <form id="login_form" class="login-form" action="" method="post">
      ...
      <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-4">
            <label class="control-label visible-ie8 visible-ie9"><?php  _e('Username','epfitness');?></label>
          </div>
          <div class="col-md-9 col-sm-8">
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="<?php  _e('Username','epfitness');?>" name="username" id="username"/>
          </div>
        </div>
      </div>
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-9 col-sm-8">
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="<?php  _e('Psssword','epfitness');?>" name="password" id="password"/>
          </div>
        </div>
      </div>
   ...
   <div class="create-account">
    <p><?php
     ...
     ?><?php  _e('Are you a new user?','epfitness');?> 
  ...
  <div class="form-content">
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        <div class="form-group">
          <input class="form-control form-control-solid placeholder-no-fix" type="text"  placeholder="<?php  _e('Email','epfitness');?>" name="forget_email" id="forget_email"/>
        </div>
