      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab_1_1">
          ...
          <form role="form" name="profile_setting_form" id="profile_setting_form" action="#">
			...
			<div class="margiv-top-10"> <label class="control-label"><?php echo _e('Image Gallery', 'epfitness'); ?></label>
			<button type="button" onclick="edit_gallery_image('gallery_image_div');"  class="btn btn-xs green-haze"><?php _e('Add Images','epfitness'); ?></button>
			<?php
         ...
         <div class="form-group">
          ...
          <input type="text" placeholder="<?php _e('Enter','epfitness'); ?> <?php echo ' '.$field_value;?>" name="<?php echo $field_key;?>" id="<?php echo $field_key;?>"  class="form-control-solid" value="<?php echo get_user_meta($current_user->ID,$field_key,true); ?>"/>
        </div>
