	...
	<div class="row">
		...
		<div id="iv-form3" class="col-md-12">
			...
			if($iv_gateway=='paypal-express'){
				...
				?>
				<form id="ep_fitness_registration" name="ep_fitness_registration" class="form-horizontal" action="<?php  the_permalink() ?>?package_id=<?php echo $package_id; ?>&payment_gateway=woocommerce&iv-submit-listing=register" method="post" role="form">
				<?php
				}
			if($iv_gateway=='stripe'){?>
					<form id="ep_fitness_registration" name="ep_fitness_registration" class="form-horizontal" action="<?php  the_permalink() ?>?&package_id=<?php echo $package_id; ?>&payment_gateway=stripe&iv-submit-stripe=register" method="post" role="form">
						...
						<div id="selected-column-1" class=" ">
							...
							<div class="form-group row"  >
								...
								<div class="col-md-9">
									...
									data-validation-length="4-12" data-validation-error-msg="<?php  esc_html_e(' The user name has to be an alphanumeric value between 4-12 characters','epfitness');?>" class="form-control ctrl-textbox" placeholder="<?php  _e('Enter User Name','epfitness');?>"  >
							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									<input type="email" class="form-control-solid" name="iv_member_email" data-validation="email"  class="form-control ctrl-textbox" placeholder="<?php  _e('Enter email address','epfitness');?>" data-validation-error-msg="<?php  esc_html_e('Please enter a valid email address','epfitness');?> " >
								</div>
							</div>
							<div class="form-group row ">
								<label  class="col-md-3 control-label"><?php  esc_html_e('Password','epfitness');?><span class="chili"></span></label>
								<div class="col-md-9">
									<input type="password" class="form-control-solid" name="iv_member_password"  class="form-control ctrl-textbox" placeholder="" data-validation="strength"
